...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        learning_rate: Union[float, Callable] = 5e-4,
        n_steps: int = 512,
        ...
        if self.wandb_use:
            ...
            wandb.init(project="RealRobot", tensorboard=False)
        ...
        if self.wandb_use:
            if (self._n_updates % 10 == 0):
                ...
                if len(self.specific_reward_info_buffer) > 0 :
                    ...
                    wandb_dict["mimic_base_pose_reward"] = safe_mean([specific_reward_info['mimic_base_pose_reward'] for specific_reward_info in self.specific_reward_info_buffer])
